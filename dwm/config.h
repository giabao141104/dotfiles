...
static Key keys[] = {
	...
	{ ShiftMask, XF86XK_AudioRaiseVolume,      spawn,          SHCMD("mpc volume +1") },
	{ ShiftMask, XF86XK_AudioLowerVolume,      spawn,          SHCMD("mpc volume -1") },
        /* Utilities */
...
static Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button2,        spawn,          SHCMD("st -e nvim /usr/src/dwm-6.2/config.h") },
	...
	{ ClkTagBar,            MODKEY,         Button3,        toggletag,      {0} },
        { ClkRootWin,           0,              Button3,        spawn,          SHCMD("st") },
};
